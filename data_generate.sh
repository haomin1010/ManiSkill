...
python save_record.py --num-episodes 2000 --base-seed 42 --delete-collision-videos
...
python tools/vis_stackcube_boxes.py \
  --traj videos/StackCube-v1/stackcube_expert.rgb.pd_ee_delta_pos.physx_cpu.h5 \
  --meta videos/StackCube-v1/stackcube_expert.rgb.pd_ee_delta_pos.physx_cpu.json \
